...
namespace AdvancedChatFeatures.Common.Configs.StyleConfigs
{
    ...
    /// </summary>
    public class ShowModIconElement : ConfigElement<bool>
    {
        ...
        public override void OnBind()
        {
            ...
            OnLeftClick += delegate
            {
                ...
                Conf.C.styleConfig.ShowModIcons = Value;
            };
        }
        ...
        private void DrawModIcon(SpriteBatch sb)
        {
            ...
            drawPosition += new Vector2(-9, -12);

            Mod mod = null;
            if (ModLoader.TryGetMod("ModLoader", out Mod m))
                mod = m;

            DrawHelper.DrawSmallModIcon(sb, mod: mod, drawPosition, 26);
        }
