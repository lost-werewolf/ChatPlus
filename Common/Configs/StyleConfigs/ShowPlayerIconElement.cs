...
using static AdvancedChatFeatures.Common.Configs.Config;
...
namespace AdvancedChatFeatures.Common.Configs.StyleConfigs
{
    ...
    /// </summary>
    public class ShowPlayerIconElement : ConfigElement<bool>
    {
        ...
        public override void OnBind()
        {
            ...
            OnLeftClick += delegate
            {
                ...
                Conf.C.styleConfig.ShowPlayerIcons = Value;
            };
        }
        ...
        private void DrawPlayerIcon(SpriteBatch sb)
        {
            ...
            DrawHelper.DrawPlayerHead(drawPosition, sb: sb, color: Color.White*0.5f);
        }
