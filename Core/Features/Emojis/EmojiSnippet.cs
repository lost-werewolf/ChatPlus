...
public class EmojiSnippet : TextSnippet
{
        ...
        Vector2 pos = default, Color color = default, float scale = 1f)
    {
        ...
        {
            sb.End();
            sb.Begin(SpriteSortMode.Immediate, BlendState.AlphaBlend, SamplerState.LinearClamp, DepthStencilState.Default, RasterizerState.CullNone, grayscaleEffect.Value.Value);
